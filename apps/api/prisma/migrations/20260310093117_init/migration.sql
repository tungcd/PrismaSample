-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MANAGER', 'STAFF', 'PARENT', 'STUDENT');

-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('TOP_UP', 'PURCHASE', 'REFUND', 'ADJUSTMENT');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INFO', 'SUCCESS', 'WARNING', 'ERROR', 'ORDER', 'PAYMENT', 'TOPUP');
...
-- CreateIndex
CREATE INDEX "Student_cardNumber_idx" ON "Student"("cardNumber");
...
-- AddForeignKey
ALTER TABLE "TopUpRequest" ADD CONSTRAINT "TopUpRequest_approvedBy_fkey" FOREIGN KEY ("approvedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
